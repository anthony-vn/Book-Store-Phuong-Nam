...
public class Adapter_HoaDon extends BaseAdapter implements Filterable {
    ...
    public Adapter_HoaDon(Activity context, List<HoaDon> arrayHoaDon) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.img = (ImageView) convertView.findViewById(R.id.img_avatar_hoadon);
            holder.txtMaHoaDon = (TextView) convertView.findViewById(R.id.tv_mahoadon);
            holder.txtNgayMua = (TextView) convertView.findViewById(R.id.tv_date_hoadon);
            holder.imgDelete = (ImageView) convertView.findViewById(R.id.img_delete_hoadon);
        ...
        holder.img.setImageResource(R.drawable.ic_analytics);
